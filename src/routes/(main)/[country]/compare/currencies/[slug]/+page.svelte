                                ...
                                <td>
                                    <a href="/converter/{pair_changer.changer_code}?Amount=1&From=USD&To=NGN" class="flex items-center">
                                        <span class="provider-icon">
                                            <img width="22px" height="22px" src={getIconPath(changers[pair_changer.changer_code].icon)} class="rounded-full" alt="{changers[pair_changer.changer_code].name} icon">
                                        </span>
